...
<div class="content-wrapper">
  ...
  <div class="card-header">
    ...
    <div class="card-header-form">
      {{-- Form Pencarian --}}
      <form action="{{ route('admin.data_warga') }}" method="GET">
        <div class="input-group">
          <input type="text" class="form-control" placeholder="Cari berdasarkan nama, NIK, NIW..." name="search"
          ...
          <div class="card">
            ...
            <div class="card-body table-responsive p-0">
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  @forelse ($data_warga as $index => $warga)
                  <tr>
